...
チャットパネルから Azure OpenAI (gpt-4o-mini) × Microsoft Agent Framework の AI エージェントに指示できます。
...
| Azure OpenAI / OpenAI | gpt-4o-mini 推論エンジン |
...
| `AZURE_OPENAI_MODEL_NAME` | モデル名（例: `gpt-4o-mini`） |
